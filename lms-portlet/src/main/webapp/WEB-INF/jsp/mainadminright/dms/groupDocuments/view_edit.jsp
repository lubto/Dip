...
%>
 <portlet:actionURL name="<%= ACTION_EDIT_GROUP_DOC%>" var="actionUrl" >
...
<div class="admin-right">  
    <span class="sideMape"><a href="${backToCourseUrl}"><spring:message code="label-course" /></a> > <c:out value="${shortcutC}" /> > <a href="${backUrl}"><spring:message code="mal-all-group-documents" /></a> > <spring:message code="common-btn-edit" /></span>
    <h3><spring:message code="title-edit-group-doc" /></h3>
    <c:set var="heading" value="lms-msg-dummy-save" />
