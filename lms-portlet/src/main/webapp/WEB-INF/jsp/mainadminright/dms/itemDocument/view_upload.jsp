...
%>
<portlet:actionURL var="editCaseURL" name="<%=ACTION_UPLOAD_DMS%>" >
...
<div class="admin-right"> 
    ...
    <liferay-ui:error key="ErrorKey" message="err-msg-duplicate-folder" /> 
    <h3><spring:message code="title-create-item-doc" /></h3>
    <c:set var="heading" value="lms-msg-dummy-create" />
    <%@include file="components/form_item_upload.jspf" %>
</div>