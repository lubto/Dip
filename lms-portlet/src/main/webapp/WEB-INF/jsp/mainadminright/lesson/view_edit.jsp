...
%>
 <portlet:actionURL name="<%= ACTION_SAVE_LESSON %>" var="actionUrl" >
...
<div class="admin-right"> 
    <span class="sideMape"><a href="${backToCourseUrl}"><spring:message code="label-course" /></a> > <c:out value="${shortcutC}" /> > <a href="${backUrl}"><spring:message code="title-lesson" /></a> > <spring:message code="common-btn-edit" /></span> 
    <h3><spring:message code="title-edit-lesson" /></h3>
