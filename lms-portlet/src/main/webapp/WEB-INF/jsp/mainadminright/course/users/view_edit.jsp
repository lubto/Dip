...
%>
<portlet:actionURL name="<%= ACTION_SAVE_COURSE_ITEM %>" var="actionUrl">
...
<div class="admin-right">
    <span class="sideMape"><a href="${courseUrl}"><spring:message code="label-course" /></a> ><a href="${backUrl}"> <spring:message code="label-user" /></a>> <spring:message code="common-btn-edit" /></span> 
    ...
    <%@include file="components/form_course_item.jspf" %>
</div>