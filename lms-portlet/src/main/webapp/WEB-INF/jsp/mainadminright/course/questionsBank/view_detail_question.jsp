...
<span class="sideMape"><a href="${backToCourseUrl}"><spring:message code="label-course" /></a> > <c:out value="${shortcutC}" /> > <a href="${backUrl}"><spring:message code="side-map-bank" /></a> > <c:out value="${shortcutName}" /> > <spring:message code="side-map-detail" /></span> 

       

    <h3><spring:message code="title-detail-question" /></h3> 
    <liferay-ui:success key="SuccessKey" message="msg-success-create-question" />  
    ...
    <form action="#" method="post" name="fm1" id="fm1">
        ...
        <c:forEach var="listVar" items="${itemMPto}"  > 
