...
%>
<portlet:actionURL name="<%= ACTION_SAVE_Q_BANK%>" var="actionUrl" />  
...
<div class="admin-right">  
    ...
    <span class="sideMape"><spring:message code="side-map-queston" /> > <a href="${backUrl}"><spring:message code="side-map-bank" /></a> > <c:out value="${shortcutName}" /> > <spring:message code="side-map-edit" /></span>  
    ...
    <form:form id="fm" modelAttribute="<%= ATTR_QUIZ_BANK_PTO%>" action="${actionUrl}" method="post" headingCode="${heading}"  name="fm">
        ...
        <table width="100%"> <tr>
            ...
            <tr>
                <td style="text-align: right;"><form:label  path="numberQForTest"><spring:message code="map-number-q-gor-test"/></form:label></td>
